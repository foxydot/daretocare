...
<div class="meta_control">
    <div class="table">
        <div class="row">
            <div class="cell">
                <?php $metabox->the_field('involved_url'); ?>
                <label>Get Involved URL</label>
        ...
        <div class="row">
            <div class="cell">
                <?php $metabox->the_field('involved_hover_color'); ?>
        ...
        <div class="row">
            ...
            <div class="input_container">
                <?php $mb->the_field('involved_hover_image'); ?>
                ...
                <?php $group_name = 'involved_hover_img'. $mb->get_the_index(); ?>
        ...
        <div class="row">
            <div class="cell">
                ...
                <?php $metabox->the_field('involved_start_date'); ?>
                ...
                <?php $metabox->the_field('involved_start_time'); ?>
        ...
        <div class="row">
            <div class="cell">
                <?php $metabox->the_field('involved_end_datestamp'); ?>
                ...
                <?php $metabox->the_field('involved_end_date'); ?>
                <div class="input_container half"><input type="text" class="datepicker" value="<?php $metabox->the_value(); ?>" id="<?php $metabox->the_name(); ?>" name="<?php $metabox->the_name(); ?>"></div>
                <?php $metabox->the_field('involved_end_time'); ?>
                <div class="input_container half"><input type="text" class="timepicker" value="<?php $metabox->the_value(); ?>" id="<?php $metabox->the_name(); ?>" name="<?php $metabox->the_name(); ?>"></div>
            </div>
        </div>
    </div>
